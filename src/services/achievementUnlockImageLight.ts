/**
 * Achievement Unlock Image Light Service - Renders light mode achievement unlock cards as images
 *
 * Light mode version using Puppeteer to render the AchievementUnlockCardLight React component.
 *
 * @module services/achievementUnlockImageLight
 */

import React from 'react';
import ReactDOMServer from 'react-dom/server';
import AchievementUnlockCardLight from '../components/AchievementUnlockCardLight';
...
/**
 * Service for rendering achievement unlock cards as images (light mode)
 */
class AchievementUnlockImageLightService {
  // Browser management now handled by shared browser pool

  /**
   * Generate an achievement unlock celebration image in light mode
   *
  ...
  async generateAchievementUnlockImage(
    ...
    try {
      ...
      const html = ReactDOMServer.renderToStaticMarkup(
        React.createElement(AchievementUnlockCardLight, {
          username,
          avatarUrl,
...
export const achievementUnlockImageLightService = new AchievementUnlockImageLightService();
