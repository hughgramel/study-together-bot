...
export class GroupOverviewImageService {
  ...
  async generateGroupOverviewImage(
    ...
    try {
      ...
      const component = React.createElement(GroupOverview, {
        groupRank,
        groupName,
        groupId,
        currentMembers,
  ...
  /**
   * Generate a group leaderboard image
   */
  async generateGroupLeaderboardImage(
    ...
    try {
      ...
      // Render React component to HTML
      const component = React.createElement(GroupLeaderboard, {
        groups,
      });
...
export const groupOverviewImageService = new GroupOverviewImageService();
