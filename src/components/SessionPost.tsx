...
export const SessionPost: React.FC<SessionPostProps> = ({
  ...
  return (
    <div className="w-[700px] h-[700px] bg-white flex flex-col justify-center p-10 overflow-hidden">
      ...
      <div className="flex flex-col min-h-0 flex-shrink">
        ...
        <div className="flex items-center gap-3 mb-6 flex-shrink-0">
          ...
          <div className="flex flex-col overflow-hidden">
            <h2 className="text-[#1A1A1A] text-xl font-bold truncate max-w-[600px]">
              {username}
            </h2>
            {date && (
              <p className="text-[#666666] text-base font-normal truncate max-w-[600px]">
                {date}
              </p>
            )}
          </div>
        ...
        {/* Title */}
        {title && (
          <h1 className="text-[#1A1A1A] text-3xl font-extrabold mb-3 leading-tight flex-shrink-0">
            {title}
          </h1>
        )}
        ...
        {description && (
          <p className="text-[#3C3C3C] text-2xl font-normal mb-6 leading-relaxed overflow-hidden" style={{
            display: '-webkit-box',
            WebkitLineClamp: 8,
        ...
        {/* Duration card */}
        <div className="bg-[#F7F7F7] rounded-xl p-4 border-2 border-[#E5E5E5]">
          <div className="flex items-center gap-3">
            ...
            <div className="text-2xl font-extrabold text-[#3C3C3C] leading-none">
              {duration}
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#F7F7F7] rounded-xl p-4 border-2 border-[#E5E5E5]">
          <div className="flex items-center gap-3">
            ...
            <div className="text-xl font-extrabold text-[#3C3C3C] leading-none">
              {activity}
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#F7F7F7] rounded-xl p-4 border-2 border-[#E5E5E5]">
          <div className="flex items-center gap-3">
            ...
            <div className="text-2xl font-extrabold text-[#3C3C3C] leading-none font-mono">
