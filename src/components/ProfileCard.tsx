...
export const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div className="w-[700px] h-[650px] bg-[#F7F7F7] flex flex-col p-10 pb-6 relative">
      ...
      <div className="absolute top-16 right-16 w-80">
        ...
        <div className="h-5 bg-[#e5e5e5] rounded-full overflow-hidden">
          <div
      ...
      <div className="flex items-center gap-6 mb-6">
        {avatarUrl ? (
          ...
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#58CC02] to-[#4CAF00] flex items-center justify-center text-5xl border-4 border-white">
            👤
          </div>
        )}
